...
HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["app-home"]], decls: 43, vars: 3, consts: [[1, "page"], [1, "page-haader", "d-flex", "justify-content-center", "text-light"], [1, "responsive-text"], [1, "text-light", "text-center", "tow-tables"], [1, "table-striped", "table-dark", "rounded"], ["scope", "col"], ["height", "100", 4, "ngFor", "ngForOf"], ["height", "100"], ["scope", "row"], [1, "text-center"], [3, "src", "width", "height"], [3, "routerLink"], [1, "col"], [1, "btn", "btn-primary", 2, "margin-right", "5px", 3, "click"], [1, "d-inline", "text-danger"], [1, "d-inline"]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
